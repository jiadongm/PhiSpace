...
for(sim in 1:Nsim){
  ...
  comboATAC <- do.call(
    cbind,
    bridgeATAC_list[queryBatchNames]
  )
  gc()
...
# This result is using scran to normalise all query batches, leading to better results
# saveRDS(out, paste0(dat_dir, "output/Case2/clus_res_cor_PCAonly.rds")) 
saveRDS(out, paste0(dat_dir, "output/Case2/clus_res_cor_PCAonly_stack.rds"))
