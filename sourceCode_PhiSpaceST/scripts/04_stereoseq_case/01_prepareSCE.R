...
source(file.path(paths$project_root, "scripts/04_stereoseq_case/_utils.R"))
...
### scRNA-seq from the same mouse as Stereo-seq above
querySC <- readRDS(
...
pd <- import("pandas")
# Two batches
ref1 <- sc$read_h5ad(file.path(paths$data_root, "Stereo-CITE/CITE-seq/spleen_lymph_206.h5ad"))
ref2 <- sc$read_h5ad(file.path(paths$data_root, "Stereo-CITE/CITE-seq/spleen_lymph_111.h5ad"))
